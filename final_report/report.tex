...
\hypertarget{specific-aim-1-to-explore-features-distinguishing-people-with-and-without-pd.}{%
\section{Specific Aim 1: To explore features distinguishing people with
and without
PD.}\label{specific-aim-1-to-explore-features-distinguishing-people-with-and-without-pd.}}
...
\hypertarget{task-1---investigate-key-baseline-characteristics-prior-to-pd-onset}{%
\subsection{Task 1 - Investigate key baseline characteristics prior to
PD
onset}\label{task-1---investigate-key-baseline-characteristics-prior-to-pd-onset}}
...
\begin{figure}
\centering
\includegraphics{../assets/Figure 1 - Workflow of Aim 1 - Task 1.png}
\caption{Figure 1: Workflow of Aim 1 - Task 1}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{../assets/Figure 2 - Odds Ratio of PD for Statistically Significant Variables.png}
...
\begin{figure}
\centering
\includegraphics{../assets/Figure 3 - Workflow of Aim 1 - Task 2.png}
\caption{Figure 3: Workflow of Aim 1 - Task 2}
\end{figure}
