...
- Feature Engineering and Matching: Exploring the relationship between features and the response variable with basic visualization tools, and conducting appropriate feature engineering such as binning and encoding (as there are too many features in dataset). Additionally, considering the data imbalance and the target of classification, we will focus on matching methods to figure out samples of high value (which are close to the classification boundaries).
